...
export const generatePipes = () => {
  let topPipeHeight = randomBetween(500, (Constants.MAX_HEIGHT / 2) - 500)
...
const Physics = (entities, { touches, time }) => {
    ...
    Object.keys(entities).forEach(key => {
      ...
      else if (key.indexOf("floor") === 0)
      {
        ...
        {
          Matter.Body.setPosition(entities[key].body, { x: Constants.MAX_WIDTH + (Constants.MAX_WIDTH ), y: entities[key].body.position.y });
        }
